...
Das heißt: die `r Zahl_Ahnen` direkten Vorfahren/Personen entsprechen eigentlich `r Zahl_Ahnen` + `r Zahl_Doppelte_Ahnen` = `r nrow(tempDirekt)` direkten Ahnen. (richtig??)
...
# Tabelle
computeTable(data_ELTERN, Kinderzahl_der_Eltern) |> getTable()
...
# Tabelle
computeTable(data_KIDS, SUMME_KINDER) |> getTable()
