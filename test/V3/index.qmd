...
LetzteAktualisierung <- as.character(LetzteAktualisierung, format = "%d.%m.%Y")

# yy <- (year(LetzteAktualisierung))
# dd <- (day(LetzteAktualisierung))
# mm <- (month(LetzteAktualisierung))
# LetzteAktualisierung <- paste(dd, mm, yy,sep=".")
```
